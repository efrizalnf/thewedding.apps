...
import com.zlz.thewedding.syifaadi.pubnubchat.adt.ChatMessage;
import com.zlz.thewedding.syifaadi.pubnubchat.callbacks.BasicCallback;
...
public class ChatActivity extends ListActivity {
    ...
    private String channel  = "The Wedding Syifa & Adi";
            ...
            public void successCallback(String channel, final Object message) {
                try {
                   ...
                   ChatActivity.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(ChatActivity.this,"Anda dapat melakukan PING!!! pada user lain dengan melakukan Double Tap Pada baris Chat teman anda", Toast.LENGTH_LONG).show();
